...
public class movieTicketPayment extends javax.swing.JFrame {
    ...
    public movieTicketPayment(String username, String passwordd, int x) {
        userEmail = username;
        password = passwordd;
        checker = x;
        initComponents();
    ...
    public movieTicketPayment(String username, String passwordd, int x, String userFIRSTNAME, String userLASTNAME) {
        userEmail = username;
        password = passwordd;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(movieTicketPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new movieTicketPayment().setVisible(true);
            }
        });
    }
